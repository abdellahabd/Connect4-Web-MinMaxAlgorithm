  ...
  return (
    ...
    >
      <Box component={Link} to={"/"}>
        ...
        /> */}
        <div className="absolute top-0 left-0 p-2 btn justify-center m-1">
          <p className="text-green-500">return</p>
        </div>
      </Box>
      <Grid
        container
      ...
      >
        {showStart && (
          <Grid item>
            <button className="text-green-500" onClick={Start}>
              <Typography
        ...
        {!showStart && (
          <Grid item>
            <button className="text-green-500" onClick={restart}>
              <Typography
                sx={{ fontSize: { xs: "0.6rem", sm: "0.8rem", md: "1rem" } }}
              >
                REPLAY
